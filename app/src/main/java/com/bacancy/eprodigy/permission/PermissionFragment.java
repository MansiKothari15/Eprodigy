...
public class PermissionFragment {
    ...
    public void requestPermissionsText(Permission[] permissions, MultiplePermissionCallback multiplePermissionCallback) {
        if (PermissionUtils.isMarshmallowOrHigher()) {
            ...
            if (!permissionsToRequest.isEmpty()) {
                f.requestPermissions(permissionsToRequest.toArray(new String[permissionsToRequest.size()]),
    ...
    public void requestPermission(Permission permission, SinglePermissionCallback singlePermissionCallback) {
        if (PermissionUtils.isMarshmallowOrHigher()) {
            ...
            permissionsToRequest.add(permission.toString());
            if (!permissionsToRequest.isEmpty()) {
               requestPermissions(activity,permissionsToRequest.toArray(new String[permissionsToRequest.size()]),
                        PERMISSION_REQUEST_CODE);
            }
        } else {
