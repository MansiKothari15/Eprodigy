...
import com.bacancy.eprodigy.custom_loader.callback.InvalidateListener;
import com.bacancy.eprodigy.custom_loader.type.LoaderView;
import com.bacancy.eprodigy.custom_loader.util.LoaderGenerator;


public class MYLoader extends View implements InvalidateListener {
  ...
  public MYLoader(Context context, AttributeSet attrs) {
    super(context, attrs);
    initialize(context, attrs, 0);
  }

  public MYLoader(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    loaderView = LoaderGenerator.generateLoaderView(0);
    loaderView.setColor(typedArray.getColor(R.styleable.MYLoader_my_color, Color.parseColor("#ffffff")));
